...
(if (not (version<= spacemacs-emacs-min-version emacs-version))
  ...
  (let ((file-name-handler-alist nil))
    ...
    ;; Stable ELPA is mandatory on the master (stable) branch.
    ;; On the develop branch stable ELPA is not used, all packages are installed
    ;; from their last know version (latest).
